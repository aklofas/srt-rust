...
#
# Usage:
#   bash bindings/c/examples/c/scenarios/run_scenarios.sh
#   bash bindings/c/examples/c/scenarios/run_scenarios.sh [/path/to/scenarios]
#
...
#   WORKSPACE_ROOT=/path/to/ts-transformer bash bindings/c/examples/c/scenarios/run_scenarios.sh
#
# Env vars honoured:
...
# bindings/c/examples/c/scenarios/).
