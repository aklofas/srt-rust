 ...
 *      examples/getting-started/hello_world.c -ltstrans
 *
 * Run:
 ...
 *
 * From here:
 *   - For SRT sending:        muxing/mux_synthetic_srt.c
...
int main(void) {
    ...
    printf("Next: muxing/mux_synthetic_srt.c sends synthetic frames over SRT.\n");
    return 0;
}
