/*
 * send_synthetic.c — Minimal SRT sender: synthetic H.264 video + KLV → MPEG-TS over SRT.
 *
 ...
 *      -L target/debug \
 *      -Wall -Werror \
 *      -o /tmp/send_synthetic \
 *      bindings/c/tst-c/examples/c/muxing/send_synthetic.c -ltstrans
 *
 * Run (sender):
 ...
 *
 * Mirrors examples/sending/pipeline_send_to_socket.rs (Rust).
 */
