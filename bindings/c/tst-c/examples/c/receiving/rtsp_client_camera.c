/*
 * rtsp_client_camera.c — Full RTSP client lifecycle against a camera
 ...
 *      -Wall -Wextra -Werror \
 *      -lpthread \
 *      -o /tmp/rtsp_client_camera \
 *      bindings/c/tst-c/examples/c/receiving/rtsp_client_camera.c -ltstrans
 *
