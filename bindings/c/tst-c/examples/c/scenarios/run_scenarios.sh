...
#   bash bindings/c/tst-c/examples/c/scenarios/run_scenarios.sh [/path/to/scenarios]
#
...
#   WORKSPACE_ROOT=/path/to/ts-transformer bash bindings/c/tst-c/examples/c/scenarios/run_scenarios.sh
#
# Env vars honoured:
...
# bindings/c/tst-c/examples/c/scenarios/).
...
INCLUDE_DIR="$WORKSPACE_ROOT/bindings/c/tst-c/include"
