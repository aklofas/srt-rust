...
fn committed_header_matches_cbindgen_output() {
    ...
    if generated != expected {
        eprintln!(
            "Drift between bindings/c/tst-c/include/tstrans.h and cbindgen output. \
             Run `cargo build -p tst-c && cp target/debug/include/tstrans.h bindings/c/tst-c/include/tstrans.h` \
             and commit the diff."
        );
