...
class UasDatalinkLs:
    ...
    target_width_extended_m: Optional[float] = ...
    density_altitude_extended_m: Optional[float] = ...
    sensor_ellipsoid_height_extended_m: Optional[float] = ...
    alternate_platform_ellipsoid_height_extended_m: Optional[float] = ...
    range_to_recovery_km: Optional[float] = ...
    platform_course_angle_deg: Optional[float] = ...
    altitude_agl_m: Optional[float] = ...
    radar_altimeter_m: Optional[float] = ...
    sensor_azimuth_rate_dps: Optional[float] = ...
    sensor_elevation_rate_dps: Optional[float] = ...
    sensor_roll_rate_dps: Optional[float] = ...
    mi_storage_percent_full: Optional[float] = ...
    transmission_frequency_mhz: Optional[float] = ...
    zoom_percentage: Optional[float] = ...
    time_airborne_s: Optional[int] = ...
    propulsion_unit_speed_rpm: Optional[int] = ...
    navsats_in_view: Optional[int] = ...
    positioning_method_source: Optional[int] = ...
    platform_status: Union[PlatformStatus, int, None] = ...
    sensor_control_mode: Union[SensorControlMode, int, None] = ...
    take_off_time_us: Optional[int] = ...
    mi_storage_capacity_gb: Optional[int] = ...
    leap_seconds: Optional[int] = ...
    correction_offset_us: Optional[int] = ...
    active_payloads: Optional[bytes] = ...
...
class RvtPoi:
    ...
    poi_type: Union[RvtPoiType, int, None] = ...
    text: Optional[str] = ...
...
class RvtAoi:
    ...
    corner_lat_p3_deg: Optional[float] = ...
    corner_lon_p3_deg: Optional[float] = ...
    aoi_type: Union[RvtAoiType, int, None] = ...
    text: Optional[str] = ...
    source_id: Optional[str] = ...
    label: Optional[str] = ...
    operation_id: Optional[str] = ...
...
class RvtLs:
    crc32: Optional[int] = ...
    timestamp_us: Optional[int] = ...
    platform_true_airspeed: Optional[int] = ...
    platform_indicated_airspeed: Optional[int] = ...
    telemetry_accuracy_indicator: Optional[int] = ...
    frag_circle_radius_m: Optional[int] = ...
    frame_code: Optional[int] = ...
    rvt_ls_version: Optional[int] = ...
    video_data_rate: Optional[int] = ...
    digital_video_file_format: Optional[str] = ...
    user_defined: Tuple[RvtUserData, ...] = ...
    points_of_interest: Tuple[RvtPoi, ...] = ...
    areas_of_interest: Tuple[RvtAoi, ...] = ...
    aircraft_mgrs_zone: Optional[int] = ...
    aircraft_mgrs_band_grid: Optional[str] = ...
    aircraft_mgrs_easting_m: Optional[int] = ...
    aircraft_mgrs_northing_m: Optional[int] = ...
    frame_center_mgrs_zone: Optional[int] = ...
    frame_center_mgrs_band_grid: Optional[str] = ...
    frame_center_mgrs_easting_m: Optional[int] = ...
    frame_center_mgrs_northing_m: Optional[int] = ...
    unknown: Tuple[Tuple[int, bytes], ...] = ...
    field_errors: Tuple[KlvFieldError, ...] = ...
    def with_(self, **changes: object) -> RvtLs: ...
    @property
    def aircraft_mgrs(self) -> Optional[str]: ...
    @property
    def frame_center_mgrs(self) -> Optional[str]: ...

def decode_rvt(buf: _BytesLike) -> RvtLs: ...
def decode_rvt_standalone(buf: _BytesLike) -> RvtLs: ...
def encode_rvt(record: RvtLs) -> bytes: ...
def encode_rvt_standalone(record: RvtLs) -> bytes: ...
...
class CotConfig:
    platform_type: str = ...
    update_interval_us: int = ...
    producer: str = ...
    geoid_undulation_m: Optional[float] = ...
    how: str = ...

def platform_position_xml(
    record: UasDatalinkLs, *, config: Optional[CotConfig] = ..., generated_us: int
) -> str: ...
def sensor_point_of_interest_xml(
    record: UasDatalinkLs, *, config: Optional[CotConfig] = ..., generated_us: int
) -> str: ...
def platform_uid(record: UasDatalinkLs) -> str: ...
def spi_uid(record: UasDatalinkLs) -> str: ...
