 ...
 * `crates/tst-py/tests/test_scenarios.py` exactly.
 *
 ...
 *   gcc -I crates/tst-c/include -L target/debug -Wall -Werror \
 *       -o /tmp/run_scenarios \
 *       crates/tst-c/examples/c/scenarios/run_scenarios.c -ltstrans
 ...
 *   This works when invoked from within crates/tst-c/ or from the workspace
...
int main(int argc, char **argv) {
     ...
     *   - CWD = ts-transformer/crates/tst-c/ (e.g. after `cd` for the build step)
