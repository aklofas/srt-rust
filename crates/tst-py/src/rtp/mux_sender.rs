...
//!   `crates/tst-py/src/rtp/server.rs::PyMountHandle` shape (single +
...
/// `crates/tst-py/src/rtp/server.rs` and the audit-#10 pattern used in
/// `crates/tst-py/src/mpegts.rs::PyDemuxer::feed`.
...
impl PyMuxSender {
    ...
    //
    // Mirror `crates/tst-py/src/rtp/server.rs::PyMountHandle` 1:1 for
