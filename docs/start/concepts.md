...
ts-transformer ships typed Rust structs for all four sets: encode a typed `St0601Record` into KLV bytes, or decode KLV bytes into a typed `St0601Record`. See [`guides/klv.md`](/docs/guides/klv.md).
