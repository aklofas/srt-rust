...
Diff from §1: replace the hand-rolled matcher with `Pairer::nearest_pts`
...
- [§24 — Pair sync-KLV with video AUs via `Pairer::nearest_pts` (Realtime)](../../docs/cookbook.md#24-pair-sync-klv-with-video-aus-via-pairernearest_pts-realtime)
- [§25 — Pair sync-KLV in batch mode (`MatchMode::Buffered`)](../../docs/cookbook.md#25-pair-sync-klv-in-batch-mode-matchmodebuffered)
