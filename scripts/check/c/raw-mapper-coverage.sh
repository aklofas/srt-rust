...
# in the raw record_*_error mappers in bindings/c/core/src/error.rs BEFORE
...
# routing that scripts/check/rust/shell-error-kind-coverage.sh /
# scripts/check/rust/pipeline-kind-classification.sh guard.
#
...
TST_C_ERROR="bindings/c/core/src/error.rs"
...
if [[ $missing -gt 0 ]]; then
    ...
    echo "path, add it to the excluded list in scripts/check/c/raw-mapper-coverage.sh"
